  ...
  return (
    <div className='text-black bg-white'>
      <div className=' max-w-[1240px] m-auto'>
        ...
        <div className='z-10 grid grid-cols-2 py-6 bg-white'>
          ...
          <div className={`z-5 ease-in-out duration-300 ${arrow ? 'mt-[-500px]' : 'mt-2 my-8 flex flex-col justify-center'}`}>
          ...
          <div className='max-w-[1240px]'  onClick={turn}>
