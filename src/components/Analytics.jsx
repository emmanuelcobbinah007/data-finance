    ...
    <div className='w-full bg-white py-16 px-4 text-black'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center pt-2 md:w-[100%] w-[90%] mx-auto'>
                ...
                <h1 className='md:text-3xl text-2xl font-bold py-1'>Manage Data Analytics Centrally</h1>
                ...
                <button className='text-[#00df9a] bg-black w-[180px] md:mx-0 m-auto rounded-md py-2 my-4'>Get Started</button>
            </div>
        </div>
    </div>
  )
